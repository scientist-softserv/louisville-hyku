...
class Image < ActiveFedora::Base
  ...
  property :photo_comment, predicate: ::RDF::Vocab::DC.abstract, multiple: false do |index|
    index.as :stored_searchable
  end
  ...
  property :story, predicate: ::RDF::URI.new("https://purl.org/vra/hasContext"), multiple: false do |index|
    index.as :stored_searchable
  end
  ...
  property :tab_heading, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_Sublocation"), multiple: false do |index|
    index.as :stored_searchable
  end
