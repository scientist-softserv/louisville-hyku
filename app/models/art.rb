...
class Art < ActiveFedora::Base
  ...
  property :ordering_information, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_UsageAndAccessPolicy"), multiple: false
  ...
  property :condition, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/madsrdf/v1.html#historyNote"), multiple: true
  ...
  property :cultural_context, predicate: ::RDF::URI.new("https://purl.org/vra/culturalContext"), multiple: false
  ...
  property :measurement, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_dimensions"), multiple: false

  property :object_location, predicate: ::RDF::URI.new("https://purl.org/vra/placeOfOwnership"), multiple: false

  property :ornamentation, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_illustrativeContent"), multiple: true
