...
class Art < ActiveFedora::Base
  ...
  #property :administrative_note, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_Note"), multiple: false do |index|
    #index.as :stored_searchable
  #end

  property :variant_title, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_VariantTitle"), multiple: true do |index|
    index.as :stored_searchable
  end

  #property :artificial_collection, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_Collection"), multiple: true do |index|
    #index.as :stored_searchable
  #end
  ...
  #property :object_type, predicate: ::RDF::Vocab::DC.type, multiple: false do |index|
    #index.as :stored_searchable
  #end

  property :ordering_information, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_UsageAndAccessPolicy"), multiple: false do |index|
    index.as :stored_searchable
  end
  ...
  #property :people_pictured, predicate: ::RDF::Vocab::FOAF.depiction, multiple: true do |index|
    #index.as :stored_searchable
  #end
  ...
  property :biography_of_contributor, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_credits"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :cataloguing_note, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_DescriptionConventions"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :condition, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/madsrdf/v1.html#historyNote"), multiple: true do |index|
    index.as :stored_searchable
  end

  property :contributor_description, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_Summary"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :contributor_history, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_historyOfWork"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :cultural_context, predicate: ::RDF::URI.new("https://purl.org/vra/culturalContext"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :data_source, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_references"), multiple: false do |index|
    index.as :stored_searchable
  end
  ...
  property :language_script, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#c_Notation"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :location_of_contributor, predicate: ::RDF::URI.new("https://purl.org/vra/placeOfCreation"), multiple: true do |index|
    index.as :stored_searchable
  end

  property :location_of_honoree, predicate: ::RDF::URI.new("https://purl.org/vra/locationOf"), multiple: true do |index|
    index.as :stored_searchable
  end

  property :material, predicate: ::RDF::URI.new("https://purl.org/vra/material"), multiple: true do |index|
    index.as :stored_searchable
  end

  property :measurement, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_dimensions"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :object_location, predicate: ::RDF::URI.new("https://purl.org/vra/placeOfOwnership"), multiple: false do |index|
    index.as :stored_searchable
  end

  property :ornamentation, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_illustrativeContent"), multiple: true do |index|
    index.as :stored_searchable
  end

  property :place_original, predicate: ::RDF::URI.new("https://id.loc.gov/ontologies/bibframe.html#p_originPlace"), multiple: true do |index|
    index.as :stored_searchable
  end

  property :related_image, predicate: ::RDF::Vocab::DC.temporal, multiple: true do |index|
    index.as :stored_searchable
  end
  ...
  property :technique, predicate: ::RDF::URI.new("https://purl.org/vra/hasTechnique"), multiple: true do |index|
    index.as :stored_searchable
  end
