...
xml.feed("xmlns" => "http://www.w3.org/2005/Atom",
  ...
  xml.link    "rel" => "alternate",
              "href" => url_for(search_state.to_h.merge(only_path: false, format: "html")),
              "type" => "text/html"
  xml.id      url_for(search_state.to_h.merge(:only_path => false,
                                              :format => "html",
                                              :content_format => nil,
                                              "type" => "text/html"))
  ...
  @document_list.each_with_index do |document, document_counter|
    xml << Nokogiri::XML.fragment(render_document_partials(document,
